...
from DiT.models import DiT_XL_2, DiT_S_8
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='imagenet',
                        choices=['imagenet', 'objectnet', 'imagenetv2', 'imagenetA', 'alzheimers-32'],
                        help='Dataset to use')
    ...
    # model = DiT_S_8(input_size=latent_size).to(device)
    # state_dict = find_model(f"DiT-S-8-{image_size}x{image_size}.pt")
